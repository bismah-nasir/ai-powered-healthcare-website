          ...
          <div className="w-full flex flex-col md:flex-row gap-8 items-start">
            ...
            <form onSubmit={handleBookingSubmit} className="grow w-full glass-panel rounded-3xl p-8 flex flex-col gap-6">
              ...
              <button
                ...
                className="btn btn-primary w-full py-4 rounded-2xl text-base font-semibold mt-2 disabled:opacity-75 disabled:cursor-not-allowed disabled:pointer-events-none"
              >
